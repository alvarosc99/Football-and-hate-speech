...
dfull2 %>% 
  ...
  labs(title = "Hate speech concentrates Before & After the match",
       subtitle = "Blabla") +
  annotate(
    "text", x = as.POSIXct("2022-12-06 21:00"), y = 5.5,
    label = "= match",
    color = "black"
  ) +
  annotate(geom = "point", 
           x = as.POSIXct("2022-12-06 20:20"), y = 5.5, color = "grey", size = 3, shape = 16, alpha = 0.8)
```
